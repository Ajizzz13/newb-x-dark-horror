...
#define NL_SATURATION 0.88            // [toggle] 0.0 grayscale ~ 4.0 super saturated
#define NL_TINT                      // [toggle] enable light/dark tone tinting
#define NL_TINT_LOW  vec3(0.25,0.35,0.65) // color tint for dark tone (cold eerie navy)
#define NL_TINT_HIGH vec3(1.15,0.88,0.72) // color tint for light tone (bleak harsh sunlight)
/* Lighting */
...
#define NL_MIN_LIGHTING_BOOST   0.10 // 1.0 minimal lighting boost for dark areas ~ 3.0 brighter dark areas (crushed for pitch black horror)
...
#define NL_MIST_DENSITY 0.42      // 0.0 no mist ~ 1.0 misty (dense horror mist)
...
#define NL_DAWN_ZENITH_COL   vec3(0.08,0.15,0.35)
#define NL_DAWN_HORIZON_COL  vec3(1.8,0.25,0.15)
#define NL_DAWN_EDGE_COL     vec3(1.2,0.40,0.25)
#define NL_DAY_ZENITH_COL    vec3(0.20,0.50,0.95)
#define NL_DAY_HORIZON_COL   vec3(0.75,0.95,1.10)
#define NL_DAY_EDGE_COL      vec3(0.85,1.00,1.08)
