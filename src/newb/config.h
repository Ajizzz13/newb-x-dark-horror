...
#define NL_SATURATION 0.90            // [toggle] 0.0 grayscale ~ 4.0 super saturated
...
#define NL_TORCHLIGHT_INTENSITY 1.30 // 0.5 weak ~ 3.0 bright
#define NL_SHADOW_INTENSITY     0.85 // 0.0 no shadow ~ 1.0 strong shadow (heavy dark horror shadows)
#define NL_MIN_LIGHTING_BOOST   0.35 // 1.0 minimal lighting boost for dark areas ~ 3.0 brighter dark areas (crushed for dark night/caves)
...
#define NL_DAWN_SUNLIGHT_COL   vec3(1.25,0.30,0.12)
#define NL_NOON_SUNLIGHT_COL   vec3(1.05,0.85,0.70)
#define NL_NIGHT_MOONLIGHT_COL vec3(0.0006,0.0012,0.0025)

/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.0,0.46,0.12)
#define NL_UNDERWATER_TORCH_COL vec3(0.8,0.45,0.15)
#define NL_NETHER_TORCH_COL     vec3(1.0,0.46,0.12)
#define NL_END_TORCH_COL        vec3(0.8,0.40,0.90)

/* Fog */
#define NL_FOG 0.65                // [toggle] 0.1 subtle ~ 1.0 blend with sky completely (balanced to prevent blinding whiteout)
#define NL_MIST_DENSITY 0.20      // 0.0 no mist ~ 1.0 misty (creeping horror mist)
#define NL_RAIN_MIST_OPACITY 0.25 // [toggle] 0.04 very subtle ~ 0.5 thick rain mist blow
//#define NL_CLOUDY_FOG 0.1       // [toggle] 0.0 subtle - 0.8 dense fog clouds (disabled to avoid blinding wall of fog)
/* Sky */
...
#define NL_DAWN_ZENITH_COL   vec3(0.1,0.3,0.6)
#define NL_DAWN_HORIZON_COL  vec3(2.2,0.3,0.2)
#define NL_DAWN_EDGE_COL     vec3(1.5,0.6,0.4)
#define NL_DAY_ZENITH_COL    vec3(0.3,0.7,1.6)
#define NL_DAY_HORIZON_COL   vec3(0.9,1.3,1.6)
#define NL_DAY_EDGE_COL      vec3(1.2,1.3,1.4)
#define NL_NIGHT_ZENITH_COL  vec3(0.001,0.002,0.004)
#define NL_NIGHT_HORIZON_COL vec3(0.002,0.003,0.007)
#define NL_NIGHT_EDGE_COL    vec3(0.003,0.005,0.010)
#define NL_RAIN_ZENITH_COL   vec3(0.22,0.25,0.30)
#define NL_RAIN_HORIZON_COL  vec3(0.32,0.35,0.38)
...
/* Ore glow intensity */
#define NL_GLOW_TEX 5.5           // 0.4 weak ~ 8.0 bright (radiant glowing ores at night)
#define NL_GLOW_SHIMMER 0.9       // [toggle] 0.1 subtle ~ 1.0 100% shimmer
#define NL_GLOW_SHIMMER_SPEED 1.3 // 0.5 slow - 2.0 fast
#define NL_GLOW_LEAK 0.75         // [toggle] 0.08 subtle ~ 1.0 100% brightness of NL_GLOW_TEX

/* Waving */
#define NL_PLANTS_WAVE 0.07    // [toggle] 0.02 gentle ~ 0.4 violent
#define NL_LANTERN_WAVE 0.22   // [toggle] 0.05 subtle ~ 0.4 large swing
...
/* Weather particles */
#define NL_WEATHER_SPECK 0.85        // [toggle] 0.0 vanilla texture ~ 1.0 soft speck
#define NL_WEATHER_RAIN_SLANT 4.5    // 1.0 minimal ~ 8.0 violent
#define NL_WEATHER_PARTICLE_SIZE 1.25 // 0.5 tiny ~ 4.0 large
#define NL_WEATHER_NIGHT_GLOW 0.35   // [toggle] 0.1 subtle ~ 0.8 glowing particles at night
